...
TEST_CASE("soft_wca_potential - uses sane default paramters")
{
    md::soft_wca_potential pot;
...
TEST_CASE("soft_wca_potential - takes zero minimum energy at sigma")
{
    md::soft_wca_potential pot;
...
TEST_CASE("soft_wca_potential - has a finite extremum at zero distance")
{
    md::soft_wca_potential pot;
...
TEST_CASE("soft_wca_potential::evaluate_force - computes correctly directed force")
{
    md::soft_wca_potential pot;
...
TEST_CASE("soft_wca_potential - computes correct interaction")
{
    md::soft_wca_potential pot;
