...
TEST_CASE("semispring_potential - defaults to centered K=1 spring")
{
...
TEST_CASE("semispring_potential - is minimum at the equilibrium distance")
{
    md::semispring_potential pot;
...
TEST_CASE("semispring_potential::evaluate_force - computes correctly directed force")
{
    md::semispring_potential pot;
    ...
    // Zero for r < b, attractive for r > b.
...
TEST_CASE("semispring_potential - computes correct interaction")
{
    md::semispring_potential pot;
