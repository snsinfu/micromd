...
TEST_CASE("inter_subsystem_neighbor_pair_forcefield - computes correct forcefield")
{
    class test_forcefield : public md::inter_subsystem_neighbor_pair_forcefield<test_forcefield>
    {
    public:
        md::scalar inter_subsystem_neighbor_distance(md::system const&)
        {
            return 1;
        }
...
TEST_CASE("inter_subsystem_neighbor_pair_forcefield::compute_force - adds force to array")
{
    class test_forcefield : public md::inter_subsystem_neighbor_pair_forcefield<test_forcefield>
    {
    public:
    ...
    std::vector<md::index> reds = {0};
    std::vector<md::index> blacks = {1};
...
TEST_CASE("make_inter_subsystem_neighbor_pair_forcefield - creates an inter_subsystem_neighbor_pair_forcefield")
{
    md::system system;
    ...
    auto ndist = ff.inter_subsystem_neighbor_distance(system);
    auto pot = ff.inter_subsystem_neighbor_pair_potential(system, 0, 1);
